public class PhraseOMatic {
	...
	public static void main (String[] args) {
		...
		// make three sets of words to choose frin, Add your own!
		...
		String[] wordListTwo = {"loosely coupled", "sisx sigma", "asynchronous", "event driven", "pub-sub", "IoT", "cloud native", "service oriented", "containerized", "serverless", "microservices", "distributed ledger"};
